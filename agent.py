...
class Agent:
    ...
    def __call__(self):
        ...
        logger.debug(f"check syntax elapsed_time {syntax_return.elapsed_time_ms}ms")
        ...
        for modifier in self.modifiers:
            ...
            logger.debug(f"modifier elapsed_time {modifier_return.elapsed_time_ms}ms")
        ...
        for checker in self.checkers:
            ...
            logger.debug(f"checker elapsed_time {checker_return.elapsed_time_ms}ms")
